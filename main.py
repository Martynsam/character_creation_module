...
def attack(char_name: str, char_class: str) -> str:
    """Случайные показатели атаки в зависимости от класса игрока."""
...
def defence(char_name: str, char_class: str) -> str:
    """Случайные показатели защиты в зависимости от класса игрока."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Случайные показатели суперсилы в зависимости от класса игрока."""
    if char_class == 'warrior':
        return (
